...
EMA, MFI, RSI, SMA, bollinger_bands, chopiness, crossed_below, hull_moving_average, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Combined_NFIv6_SMA`
