...
```bash
freqtrade backtesting -s BBRSIOptim2020Strategy --timerange 20240101-20240301
freqtrade hyperopt -s BBRSIOptim2020Strategy --hyperopt-loss SharpeHyperOptLoss
```
