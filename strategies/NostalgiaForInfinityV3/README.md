...
```bash
freqtrade backtesting -s NostalgiaForInfinityV3 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV3 --hyperopt-loss SharpeHyperOptLoss
```
