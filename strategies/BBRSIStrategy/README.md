...
- **策略名称**: BBRSIStrategy
- **时间框架**: 15m
- **止损设置**: -0.3603667187598833
- **最小ROI**: {'0': 0.21547444718127343, '21': 0.054918778723794665, '48': 0.013037720775643222, '125': 0}
...
2. 运行回测测试策略效果: `freqtrade backtesting -s BBRSIStrategy`
