...
```bash
freqtrade backtesting -s ClucHAnix_BB_RPB_MOD_E0V1E_ROI --timerange 20240101-20240301
freqtrade hyperopt -s ClucHAnix_BB_RPB_MOD_E0V1E_ROI --hyperopt-loss SharpeHyperOptLoss
```
