...
- **策略名称**: ClucHAnix_BB_RPB_MOD_E0V1E_ROI
- **时间框架**: 5m
- **止损设置**: -0.99
...
EMA (指数移动平均)、SMA (简单移动平均)、RSI (相对强弱指标)、ADX (平均趋向指数)、ROCR (变动率比率)
...
2. 运行回测测试策略效果: `freqtrade backtesting -s ClucHAnix_BB_RPB_MOD_E0V1E_ROI`
