# NotAnotherSMAOffsetStrategyHOv3 策略分析报告
...
- **策略名称**: NotAnotherSMAOffsetStrategyHOv3
- **时间框架**: 5m
- **止损设置**: -0.3
- **最小ROI**: {'0': 10}
...
EMA, RSI, SMA, hull_moving_average, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NotAnotherSMAOffsetStrategyHOv3`
