...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategyHOv3 --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategyHOv3 --hyperopt-loss SharpeHyperOptLoss
```
