...
- **时间框架**: 15m
- **止损设置**: -0.34338
- **最小ROI**: "0": 0.27058, "33": 0.0853, "64": 0.04093, "244": 0

## 策略意图和目的

本策略是一个**RSI超买超卖、趋势判断**，旨在通过技术指标分析市场趋势，寻找买入和卖出机会。

### 核心逻辑

使用RSI指标判断市场是否处于超买或超卖状态；使用移动平均线判断市场整体趋势方向
...
2. 运行回测测试策略效果: `freqtrade backtesting -s SwingHighToSky`
