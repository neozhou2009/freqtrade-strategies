...
- **策略名称**: BB_RPB_TSL_c7c477d_20211030
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: "0": 0.10,
...
EMA (指数移动平均)、SMA (简单移动平均)、RSI (相对强弱指标)、ADX (平均趋向指数)、CCI (顺势指标)、Ichimoku (一目均衡表)
...
2. 运行回测测试策略效果: `freqtrade backtesting -s BB_RPB_TSL_c7c477d_20211030`
