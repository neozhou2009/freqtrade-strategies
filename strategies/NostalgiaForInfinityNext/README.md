# NostalgiaForInfinityNext 策略分析报告
...
ATR, DEMA, EMA, MFI, ROC, RSI, SMA, STOCHRSI, T3, TEMA, WMA, bollinger_bands, chopiness, crossed_below, heikinashi, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NostalgiaForInfinityNext`
