...
```bash
freqtrade backtesting -s NostalgiaForInfinityNext --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityNext --hyperopt-loss SharpeHyperOptLoss
```
