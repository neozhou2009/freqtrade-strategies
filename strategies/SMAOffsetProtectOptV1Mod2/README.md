...
```bash
freqtrade backtesting -s SMAOffsetProtectOptV1Mod2 --timerange 20240101-20240301
freqtrade hyperopt -s SMAOffsetProtectOptV1Mod2 --hyperopt-loss SharpeHyperOptLoss
```
