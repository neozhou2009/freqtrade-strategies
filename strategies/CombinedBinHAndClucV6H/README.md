...
```bash
freqtrade backtesting -s CombinedBinHAndClucV6H --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHAndClucV6H --hyperopt-loss SharpeHyperOptLoss
```
