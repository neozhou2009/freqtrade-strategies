...
```bash
freqtrade backtesting -s CombinedBinHClucAndMADV9 --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHClucAndMADV9 --hyperopt-loss SharpeHyperOptLoss
```
