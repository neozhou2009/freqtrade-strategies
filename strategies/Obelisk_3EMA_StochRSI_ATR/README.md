...
```bash
freqtrade backtesting -s Obelisk_3EMA_StochRSI_ATR --timerange 20240101-20240301
freqtrade hyperopt -s Obelisk_3EMA_StochRSI_ATR --hyperopt-loss SharpeHyperOptLoss
```
