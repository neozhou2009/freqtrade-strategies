...
```bash
freqtrade backtesting -s NostalgiaForInfinityV6HO --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV6HO --hyperopt-loss SharpeHyperOptLoss
```
