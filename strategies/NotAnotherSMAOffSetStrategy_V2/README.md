...
```bash
freqtrade backtesting -s NotAnotherSMAOffSetStrategy_V2 --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffSetStrategy_V2 --hyperopt-loss SharpeHyperOptLoss
```
