...
```bash
freqtrade backtesting -s NostalgiaForInfinityV5 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV5 --hyperopt-loss SharpeHyperOptLoss
```
