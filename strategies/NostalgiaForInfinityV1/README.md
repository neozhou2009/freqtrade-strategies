...
```bash
freqtrade backtesting -s NostalgiaForInfinityV1 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV1 --hyperopt-loss SharpeHyperOptLoss
```
