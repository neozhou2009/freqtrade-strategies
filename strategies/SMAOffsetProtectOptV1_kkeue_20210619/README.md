...
```bash
freqtrade backtesting -s SMAOffsetProtectOptV1_kkeue_20210619 --timerange 20240101-20240301
freqtrade hyperopt -s SMAOffsetProtectOptV1_kkeue_20210619 --hyperopt-loss SharpeHyperOptLoss
```
