# SMAOffsetProtectOptV1_kkeue_20210619 策略分析报告
...
- **策略名称**: SMAOffsetProtectOptV1_kkeue_20210619
- **时间框架**: 5m
- **止损设置**: -0.5
- **最小ROI**: {'0': 0.028, '10': 0.018, '30': 0.01, '40': 0.005}
...
2. 运行回测测试策略效果: `freqtrade backtesting -s SMAOffsetProtectOptV1_kkeue_20210619`
