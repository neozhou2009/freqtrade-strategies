...
```bash
freqtrade backtesting -s FrostAuraRandomStrategy --timerange 20240101-20240301
freqtrade hyperopt -s FrostAuraRandomStrategy --hyperopt-loss SharpeHyperOptLoss
```
