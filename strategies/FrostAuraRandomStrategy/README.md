...
- **策略名称**: FrostAuraRandomStrategy
- **时间框架**: 1h
- **止损设置**: -0.231
- **最小ROI**: {'0': 0.347, '450': 0.106, '1169': 0.032, '1624': 0}
...
2. 运行回测测试策略效果: `freqtrade backtesting -s FrostAuraRandomStrategy`
