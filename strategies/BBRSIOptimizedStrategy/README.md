...
```bash
freqtrade backtesting -s BBRSIOptimizedStrategy --timerange 20240101-20240301
freqtrade hyperopt -s BBRSIOptimizedStrategy --hyperopt-loss SharpeHyperOptLoss
```
