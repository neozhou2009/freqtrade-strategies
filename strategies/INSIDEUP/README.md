...
- **时间框架**: 1d
- **止损设置**: -0.99
- **最小ROI**: {'0': 0.237, '4195': 0.17, '7191': 0.053, '14695': 0}
...
ADX, CDL3BLACKCROWS, CDL3INSIDE, CDLMORNINGDOJISTAR, CDLPIERCING, RSI, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s INSIDEUP`
