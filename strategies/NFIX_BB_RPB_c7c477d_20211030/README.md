# NFIX_BB_RPB_c7c477d_20211030 策略分析报告
...
本策略共检测到 20 个技术指标调用。基础配置看起来相对正常。
...
- **策略名称**: NFIX_BB_RPB_c7c477d_20211030
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: {'0': 100.0}
...
ATR, BBANDS, CCI, DEMA, EMA, MFI, MOM, ROC, RSI, SMA, STOCHRSI, T3, TEMA, WMA, bollinger_bands, crossed_above, crossed_below, heikinashi, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NFIX_BB_RPB_c7c477d_20211030`
