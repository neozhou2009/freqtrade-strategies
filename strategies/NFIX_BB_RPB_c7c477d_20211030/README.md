...
```bash
freqtrade backtesting -s NFIX_BB_RPB_c7c477d_20211030 --timerange 20240101-20240301
freqtrade hyperopt -s NFIX_BB_RPB_c7c477d_20211030 --hyperopt-loss SharpeHyperOptLoss
```
