...
CCI, EMA, MACD, MAX, MFI, MIN, RSI, SMA, bollinger_bands, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s ReinforcedQuickie`
