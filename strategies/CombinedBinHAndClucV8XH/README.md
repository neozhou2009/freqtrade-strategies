...
```bash
freqtrade backtesting -s CombinedBinHAndClucV8XH --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHAndClucV8XH --hyperopt-loss SharpeHyperOptLoss
```
