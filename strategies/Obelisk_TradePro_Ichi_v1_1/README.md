...
```bash
freqtrade backtesting -s Obelisk_TradePro_Ichi_v1_1 --timerange 20240101-20240301
freqtrade hyperopt -s Obelisk_TradePro_Ichi_v1_1 --hyperopt-loss SharpeHyperOptLoss
```
