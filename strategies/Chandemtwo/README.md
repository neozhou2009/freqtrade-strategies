...
- **时间框架**: 5m
- **止损设置**: -0.33572
- **最小ROI**: {'0': 0.75242, '827': 0.39114, '2168': 0.34123, '3527': 0}
...
BBANDS, CMO, bollinger_bands, crossed_above, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Chandemtwo`
