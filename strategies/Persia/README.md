...
| 周期 | 
    ...
    formula0 = CategoricalParameter(
        formulas, default=formulas[0], optimize=0 < CONDITIONS, space= |
| 指标 | 3个: RSI,EMA,SMA |
...
```bash
freqtrade backtesting -s Persia --timerange 20240101-20240301
freqtrade hyperopt -s Persia --hyperopt-loss SharpeHyperOptLoss
```
