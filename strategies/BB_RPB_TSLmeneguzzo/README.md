...
本策略共检测到 27 个技术指标调用。基础配置看起来相对正常。
...
ADX, ATR, BBANDS, CCI, DEMA, EMA, LINEARREG, MAX, MFI, MIN, MOM, ROC, ROCR, RSI, SMA, STOCHF, STOCHRSI, T3, TEMA, TRANGE, WMA, bollinger_bands, crossed_above, crossed_below, heikinashi, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s BB_RPB_TSLmeneguzzo`
