...
ADX, CCI, EMA, MFI, RSI, SMA, STOCHF, bollinger_bands, crossed_above, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s ReinforcedSmoothScalp`
