...
| 周期 | 
    ...
    cooldown_lookback = IntParameter(2, 48, default=5, space= |
| 指标 | 1个: RSI |
...
```bash
freqtrade backtesting -s GodCard --timerange 20240101-20240301
freqtrade hyperopt -s GodCard --hyperopt-loss SharpeHyperOptLoss
```
