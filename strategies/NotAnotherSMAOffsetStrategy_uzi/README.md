...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategy_uzi --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategy_uzi --hyperopt-loss SharpeHyperOptLoss
```
