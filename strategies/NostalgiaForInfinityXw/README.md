...
```bash
freqtrade backtesting -s NostalgiaForInfinityXw --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityXw --hyperopt-loss SharpeHyperOptLoss
```
