# Combined_NFIv7_SMA_Rallipanos_20210707 策略分析报告
...
- **策略名称**: Combined_NFIv7_SMA_Rallipanos_20210707
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: {'0': 10}
...
EMA, MFI, RSI, SMA, bollinger_bands, chopiness, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Combined_NFIv7_SMA_Rallipanos_20210707`
