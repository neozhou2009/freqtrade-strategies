...
```bash
freqtrade backtesting -s Combined_NFIv7_SMA_Rallipanos_20210707 --timerange 20240101-20240301
freqtrade hyperopt -s Combined_NFIv7_SMA_Rallipanos_20210707 --hyperopt-loss SharpeHyperOptLoss
```
