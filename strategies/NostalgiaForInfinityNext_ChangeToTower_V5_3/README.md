...
```bash
freqtrade backtesting -s NostalgiaForInfinityNext_ChangeToTower_V5_3 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityNext_ChangeToTower_V5_3 --hyperopt-loss SharpeHyperOptLoss
```
