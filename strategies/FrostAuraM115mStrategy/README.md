...
```bash
freqtrade backtesting -s FrostAuraM115mStrategy --timerange 20240101-20240301
freqtrade hyperopt -s FrostAuraM115mStrategy --hyperopt-loss SharpeHyperOptLoss
```
