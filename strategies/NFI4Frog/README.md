...
本策略共检测到 17 个技术指标调用。存在高风险配置项，请务必注意。
...
ADX, ATR, DMI, EMA, MFI, ROC, RSI, SAR, SMA, SQZMI, STOCHF, VFI, bollinger_bands, crossed_above, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NFI4Frog`
