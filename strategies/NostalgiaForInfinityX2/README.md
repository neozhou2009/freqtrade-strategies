...
```bash
freqtrade backtesting -s NostalgiaForInfinityX2 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityX2 --hyperopt-loss SharpeHyperOptLoss
```
