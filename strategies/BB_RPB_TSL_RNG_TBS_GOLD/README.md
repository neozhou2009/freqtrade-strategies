...
```bash
freqtrade backtesting -s BB_RPB_TSL_RNG_TBS_GOLD --timerange 20240101-20240301
freqtrade hyperopt -s BB_RPB_TSL_RNG_TBS_GOLD --hyperopt-loss SharpeHyperOptLoss
```
