# BB_RPB_TSL_RNG_TBS_GOLD 策略分析报告
...
本策略共检测到 13 个技术指标调用。基础配置看起来相对正常。
...
ADX, CCI, EMA, RSI, SMA, STOCHF, STOCHRSI, bollinger_bands, crossed_above, crossed_below, hull_moving_average, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s BB_RPB_TSL_RNG_TBS_GOLD`
