...
```bash
freqtrade backtesting -s NostalgiaForInfinityV7 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV7 --hyperopt-loss SharpeHyperOptLoss
```
