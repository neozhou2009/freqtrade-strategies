...
| 周期 | 
    ...
    buy_bbt = DecimalParameter(
        0, 100, decimals=4, default=0.023, space= |
| 指标 | 2个: RSI,EMA |
...
```bash
freqtrade backtesting -s Dracula --timerange 20240101-20240301
freqtrade hyperopt -s Dracula --hyperopt-loss SharpeHyperOptLoss
```
