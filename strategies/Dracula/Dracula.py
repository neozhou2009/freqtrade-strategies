...
class Dracula(IStrategy):
    ...
    buy_bbt = DecimalParameter(0, 100, decimals=4, default=0.023, space="buy")
    # Buy hypers
    timeframe = "1m"
    # Protection
    fast_ewo = 50
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["ema"] = ta.EMA(dataframe, timeperiod=150)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        lost_protect = (dataframe["ema"] > (dataframe["close"] * 1.07)).rolling(
            10
        ).sum() == 0
