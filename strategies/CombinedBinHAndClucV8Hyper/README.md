...
```bash
freqtrade backtesting -s CombinedBinHAndClucV8Hyper --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHAndClucV8Hyper --hyperopt-loss SharpeHyperOptLoss
```
