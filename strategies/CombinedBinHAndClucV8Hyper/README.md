# CombinedBinHAndClucV8Hyper 策略分析报告
...
- **策略名称**: CombinedBinHAndClucV8Hyper
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: {'0': 10}
...
ATR, EMA, MFI, RSI, SMA, bollinger_bands, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s CombinedBinHAndClucV8Hyper`
