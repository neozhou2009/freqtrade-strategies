...
```bash
freqtrade backtesting -s NostalgiaForInfinityNextV7155 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityNextV7155 --hyperopt-loss SharpeHyperOptLoss
```
