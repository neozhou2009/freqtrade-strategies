...
class BBRSI4cust(IStrategy):
    ...
    buy_bb = IntParameter(
        low=1, high=4, default=1, space="entry", optimize=True, load=True
    )
    buy_di = IntParameter(
        low=10, high=20, default=20, space="entry", optimize=True, load=True
    )

    sell_bb = IntParameter(
        low=1, high=4, default=1, space="exit", optimize=True, load=True
    )
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        # Check if current_rate crosses above bb_middleband1
