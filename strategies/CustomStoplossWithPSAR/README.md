...
```bash
freqtrade backtesting -s CustomStoplossWithPSAR --timerange 20240101-20240301
freqtrade hyperopt -s CustomStoplossWithPSAR --hyperopt-loss SharpeHyperOptLoss
```
