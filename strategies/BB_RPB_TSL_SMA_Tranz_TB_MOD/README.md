...
```bash
freqtrade backtesting -s BB_RPB_TSL_SMA_Tranz_TB_MOD --timerange 20240101-20240301
freqtrade hyperopt -s BB_RPB_TSL_SMA_Tranz_TB_MOD --hyperopt-loss SharpeHyperOptLoss
```
