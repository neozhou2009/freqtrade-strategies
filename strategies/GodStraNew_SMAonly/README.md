...
本策略共检测到 4 个技术指标调用。存在高风险配置项，请务必注意。
...
- **策略名称**: GodStraNew_SMAonly
- **时间框架**: 5m
- **止损设置**: -1
- **最小ROI**: {'0': 0.288, '81': 0.101, '170': 0.049, '491': 0}
...
SMA, crossed_above, crossed_below, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s GodStraNew_SMAonly`
