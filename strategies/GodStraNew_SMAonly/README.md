...
| 周期 | 
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
         |
| 指标 | 7个: RSI,MACD,ADX,EMA,SMA,BB,ATR |
...
```bash
freqtrade backtesting -s GodStraNew_SMAonly --timerange 20240101-20240301
freqtrade hyperopt -s GodStraNew_SMAonly --hyperopt-loss SharpeHyperOptLoss
```
