...
本策略共检测到 12 个技术指标调用。基础配置看起来相对正常。
...
- **策略名称**: EXPERIMENTAL_STRATEGY
- **时间框架**: 5m
- **止损设置**: -0.1
- **最小ROI**: {'40': 0.0, '30': 0.01, '20': 0.02, '0': 0.04}
...
ADX, EMA, MACD, MINUS, PLUS, RSI, SMA, STOCHF, bollinger_bands, crossed_above, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s EXPERIMENTAL_STRATEGY`
