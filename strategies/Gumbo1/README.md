...
- **时间框架**: 5m
- **止损设置**: -0.25
- **最小ROI**: "0": 0.10, "20": 0.05, "64": 0.03, "168": 0

## 策略意图和目的

本策略是一个**布林带突破、趋势判断**，旨在通过技术指标分析市场趋势，寻找买入和卖出机会。

### 核心逻辑

使用布林带判断价格是否突破支撑或阻力位；使用移动平均线判断市场整体趋势方向
...
EMA (指数移动平均)、SMA (简单移动平均)、BB (布林带)、STOCH (随机指标)
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Gumbo1`
