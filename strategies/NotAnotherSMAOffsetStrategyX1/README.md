...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategyX1 --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategyX1 --hyperopt-loss SharpeHyperOptLoss
```
