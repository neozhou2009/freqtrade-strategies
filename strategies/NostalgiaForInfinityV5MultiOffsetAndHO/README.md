...
```bash
freqtrade backtesting -s NostalgiaForInfinityV5MultiOffsetAndHO --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV5MultiOffsetAndHO --hyperopt-loss SharpeHyperOptLoss
```
