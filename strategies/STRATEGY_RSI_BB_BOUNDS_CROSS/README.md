# STRATEGY_RSI_BB_BOUNDS_CROSS 策略分析报告
...
- **策略名称**: STRATEGY_RSI_BB_BOUNDS_CROSS
- **时间框架**: 5m
- **止损设置**: -0.1
...
EMA, MAX, RSI, bollinger_bands, crossed_above, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s STRATEGY_RSI_BB_BOUNDS_CROSS`
