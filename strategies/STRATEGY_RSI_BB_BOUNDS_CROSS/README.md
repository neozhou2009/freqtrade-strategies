...
```bash
freqtrade backtesting -s STRATEGY_RSI_BB_BOUNDS_CROSS --timerange 20240101-20240301
freqtrade hyperopt -s STRATEGY_RSI_BB_BOUNDS_CROSS --hyperopt-loss SharpeHyperOptLoss
```
