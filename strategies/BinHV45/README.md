...
| 周期 | 
    ...
    buy_bbdelta = IntParameter(low=1, high=15, default=30, space= |
| 指标 | 1个: RSI |
...
```bash
freqtrade backtesting -s BinHV45 --timerange 20240101-20240301
freqtrade hyperopt -s BinHV45 --hyperopt-loss SharpeHyperOptLoss
```
