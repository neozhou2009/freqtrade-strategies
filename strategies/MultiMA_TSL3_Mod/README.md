...
ATR, DEMA, EMA, RSI, SAR, SMA, T3, TEMA, WMA, crossed_above, crossed_below, heikinashi, hull_moving_average, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s MultiMA_TSL3_Mod`
