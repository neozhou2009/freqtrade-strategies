...
```bash
freqtrade backtesting -s SMAOffsetProtectOptV1HO1 --timerange 20240101-20240301
freqtrade hyperopt -s SMAOffsetProtectOptV1HO1 --hyperopt-loss SharpeHyperOptLoss
```
