...
```bash
freqtrade backtesting -s NFINextMultiOffsetAndHO --timerange 20240101-20240301
freqtrade hyperopt -s NFINextMultiOffsetAndHO --hyperopt-loss SharpeHyperOptLoss
```
