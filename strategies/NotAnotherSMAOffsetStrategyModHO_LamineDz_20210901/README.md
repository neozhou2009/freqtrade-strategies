# NotAnotherSMAOffsetStrategyModHO_LamineDz_20210901 策略分析报告
...
- **策略名称**: NotAnotherSMAOffsetStrategyModHO_LamineDz_20210901
- **时间框架**: 5m
- **止损设置**: -0.9
- **最小ROI**: {'0': 0.214}
...
ADX, EMA, MINUS, PLUS, RSI, SMA, hull_moving_average, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NotAnotherSMAOffsetStrategyModHO_LamineDz_20210901`
