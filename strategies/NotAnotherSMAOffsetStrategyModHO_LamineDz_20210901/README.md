...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategyModHO_LamineDz_20210901 --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategyModHO_LamineDz_20210901 --hyperopt-loss SharpeHyperOptLoss
```
