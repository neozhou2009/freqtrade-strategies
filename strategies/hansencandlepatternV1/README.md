...
CDL3LINESTRIKE, CDLENGULFING, CDLEVENINGSTAR, CDLHARAMI, CDLINVERTEDHAMMER, SMA, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s hansencandlepatternV1`
