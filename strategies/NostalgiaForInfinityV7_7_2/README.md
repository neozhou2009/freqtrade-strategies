...
```bash
freqtrade backtesting -s NostalgiaForInfinityV7_7_2 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV7_7_2 --hyperopt-loss SharpeHyperOptLoss
```
