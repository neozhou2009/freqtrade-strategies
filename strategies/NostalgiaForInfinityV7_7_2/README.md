# NostalgiaForInfinityV7_7_2 策略分析报告
...
- **策略名称**: NostalgiaForInfinityV7_7_2
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: {'0': 10}
...
ATR, CCI, DEMA, EMA, MFI, RSI, SMA, STOCHRSI, T3, TEMA, WMA, bollinger_bands, chopiness, crossed_above, crossed_below, heikinashi, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NostalgiaForInfinityV7_7_2`
