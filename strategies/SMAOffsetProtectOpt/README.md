...
- **策略名称**: SMAOffsetProtectOpt
- **时间框架**: 5m
- **止损设置**: -0.5
- **最小ROI**: {'0': 0.2, '38': 0.074, '78': 0.025, '194': 0}
...
EMA, RSI, crossed_above, crossed_below, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s SMAOffsetProtectOpt`
