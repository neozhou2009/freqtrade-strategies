...
```bash
freqtrade backtesting -s NostalgiaForInfinityV5MultiOffsetAndHO2 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV5MultiOffsetAndHO2 --hyperopt-loss SharpeHyperOptLoss
```
