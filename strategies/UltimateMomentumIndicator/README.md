...
```bash
freqtrade backtesting -s UltimateMomentumIndicator --timerange 20240101-20240301
freqtrade hyperopt -s UltimateMomentumIndicator --hyperopt-loss SharpeHyperOptLoss
```
