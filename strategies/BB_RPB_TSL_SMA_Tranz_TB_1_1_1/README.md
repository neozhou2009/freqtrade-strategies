# BB_RPB_TSL_SMA_Tranz_TB_1_1_1 策略分析报告
...
本策略共检测到 28 个技术指标调用。基础配置看起来相对正常。
...
- **策略名称**: BB_RPB_TSL_SMA_Tranz_TB_1_1_1
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: {'0': 0.205, '81': 0.038, '292': 0.005}
...
ADX, ATR, BBANDS, CCI, DEMA, EMA, LINEARREG, MAX, MFI, MIN, MOM, ROC, ROCR, RSI, SMA, STOCHF, STOCHRSI, T3, TEMA, TRANGE, WMA, bollinger_bands, chopiness, crossed_above, crossed_below, heikinashi, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s BB_RPB_TSL_SMA_Tranz_TB_1_1_1`
