...
```bash
freqtrade backtesting -s BB_RPB_TSL_SMA_Tranz_TB_1_1_1 --timerange 20240101-20240301
freqtrade hyperopt -s BB_RPB_TSL_SMA_Tranz_TB_1_1_1 --hyperopt-loss SharpeHyperOptLoss
```
