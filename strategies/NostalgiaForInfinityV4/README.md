...
```bash
freqtrade backtesting -s NostalgiaForInfinityV4 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV4 --hyperopt-loss SharpeHyperOptLoss
```
