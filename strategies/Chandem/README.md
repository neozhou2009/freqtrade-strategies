...
- **时间框架**: 5m
- **止损设置**: -0.28031
- **最小ROI**: {'0': 0.28396, '974': 0.09268, '1740': 0.06554, '3087': 0}
...
BBANDS, CMO, bollinger_bands, crossed_above, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Chandem`
