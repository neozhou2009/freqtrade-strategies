...
```bash
freqtrade backtesting -s Obelisk_Ichimoku_ZEMA_v1 --timerange 20240101-20240301
freqtrade hyperopt -s Obelisk_Ichimoku_ZEMA_v1 --hyperopt-loss SharpeHyperOptLoss
```
