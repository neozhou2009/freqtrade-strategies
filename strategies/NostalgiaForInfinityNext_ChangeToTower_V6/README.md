# NostalgiaForInfinityNext_ChangeToTower_V6 策略分析报告
...
- **策略名称**: NostalgiaForInfinityNext_ChangeToTower_V6
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: {'0': 10}
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NostalgiaForInfinityNext_ChangeToTower_V6`
