...
class NostalgiaForInfinityNext_ChangeToTower_V6(IStrategy):
    ...
    buy_ewo_17 = DecimalParameter(
        -18.0, -10.0, default=-9.4, space="buy", decimals=1, optimize=False, load=True
    )
        ...
        if last_candle["close"] > last_candle["ema_200"]:
            if last_candle["moderi_96"]:
                if current_profit >= self.sell_custom_profit_bull_11.value:
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bull_6.value
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bull_5.value
                    ) and (last_candle["cmf"] < 0.0):
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bull_4.value
                    ) and (last_candle["cmf"] < 0.0):
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bull_3.value
                    ) and (last_candle["cmf"] < 0.0):
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bull_2.value
                    ) and (last_candle["cmf"] < 0.0):
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bull_1.value
                    ) and (last_candle["cmf"] < 0.0):
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bull_0.value
                    ) and (last_candle["cmf"] < 0.0):
                ...
                if current_profit >= self.sell_custom_profit_bear_11.value:
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bear_3.value
                    ) and (last_candle["cmf"] < 0.0):
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bear_2.value
                    ) and (last_candle["cmf"] < 0.0):
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bear_1.value
                    ) and (last_candle["cmf"] < 0.0):
                    ...
                    if (
                        last_candle["rsi_14"] < self.sell_custom_rsi_under_bear_0.value
                    ) and (last_candle["cmf"] < 0.0):
        ...
        if last_candle["close"] < last_candle["ema_200"]:
            if last_candle["moderi_96"]:
                if current_profit >= self.sell_custom_under_profit_bull_11.value:
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_11.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_10.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_9.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_8.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_7.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_6.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_5.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_4.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_3.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_2.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_1.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bull_0.value
                    ) and (last_candle["cmf"] < 0.0):
                ...
                if current_profit >= self.sell_custom_under_profit_bear_11.value:
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_11.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_10.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_9.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_8.value
                    ):
                        return True, "signal_profit_u_bear_8_1"
                    elif (
                        last_candle["rsi_14"]
                        > self.sell_custom_under_rsi_over_bear_8.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_7.value
                    ):
                        return True, "signal_profit_u_bear_7_1"
                    elif (
                        last_candle["rsi_14"]
                        > self.sell_custom_under_rsi_over_bear_7.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_6.value
                    ):
                        return True, "signal_profit_u_bear_6_1"
                    elif (
                        last_candle["rsi_14"]
                        > self.sell_custom_under_rsi_over_bear_6.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_5.value
                    ):
                        return True, "signal_profit_u_bear_5_1"
                    elif (
                        last_candle["rsi_14"]
                        > self.sell_custom_under_rsi_over_bear_5.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_4.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_3.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_2.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_1.value
                    ):
                    ...
                    if (
                        last_candle["rsi_14"]
                        < self.sell_custom_under_rsi_under_bear_0.value
                    ) and (last_candle["cmf"] < 0.0):
        ...
        **kwargs,
        ...
        if hasattr(trade, "buy_tag") and trade.buy_tag is not None:
            ...
            if not buy_signal.empty:
                ...
                buy_tag = (
                    buy_signal_candle["enter_tag"]
                    if buy_signal_candle["enter_tag"] != ""
                    else "empty"
                )
    ...
    def informative_1h_indicators(
        ...
        informative_1h["seq_buy"] = informative_1h["close"] < informative_1h[
            "close"
        ].shift(4)
        informative_1h["seq_buy"] = informative_1h["seq_buy"] * (
            ...
            .groupby(
                (
                    informative_1h["seq_buy"] != informative_1h["seq_buy"].shift()
                ).cumsum()
            )
            .cumcount()
            + 1
        ...
        informative_1h["seq_sell"] = informative_1h["close"] > informative_1h[
            "close"
        ].shift(4)
        informative_1h["seq_sell"] = informative_1h["seq_sell"] * (
            ...
            .groupby(
                (
                    informative_1h["seq_sell"] != informative_1h["seq_sell"].shift()
                ).cumsum()
            )
            .cumcount()
            + 1
        ...
        for index, row in informative_1h.iterrows():
            ...
            if seq_s > 8:
                ...
                if seq_s == 9:
                    informative_1h.loc[index, "exceed_high"] = (
                        row["exceed_high"]
                        | informative_1h.loc[index - 1, "exceed_high"]
                    )
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.res_timeframe != "none":
            ...
            dataframe.rename(
                columns=lambda s: (
                    s + "_{}".format(self.res_timeframe) if "resample_" in s else s
                ),
                inplace=True,
            )
            dataframe.rename(
