...
class PRICEFOLLOWINGX(IStrategy):
    ...
    sell_rsi_enabled = BooleanParameter(
        default=True, space="sell", optimize=True, load=True
    )
    sell_frsi = DecimalParameter(
        -0.30, 0.70, decimals=2, default=0.2, space="sell", load=True
    )
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        bollinger = qtpylib.bollinger_bands(
            qtpylib.typical_price(dataframe), window=19, stds=2.2
        )
