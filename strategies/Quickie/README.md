...
本策略是一个**布林带突破、MACD交叉、趋势判断**，旨在通过技术指标分析市场趋势，寻找买入和卖出机会。

### 核心逻辑

使用布林带判断价格是否突破支撑或阻力位；使用MACD快慢线交叉判断趋势方向；使用移动平均线判断市场整体趋势方向
...
EMA (指数移动平均)、SMA (简单移动平均)、MACD (移动平均收敛散度)、ADX (平均趋向指数)、TEMA (三重指数移动平均)
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Quickie`
