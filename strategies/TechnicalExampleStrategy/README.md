...
```bash
freqtrade backtesting -s TechnicalExampleStrategy --timerange 20240101-20240301
freqtrade hyperopt -s TechnicalExampleStrategy --hyperopt-loss SharpeHyperOptLoss
```
