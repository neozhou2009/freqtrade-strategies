...
```bash
freqtrade backtesting -s NowoIchimoku5mV2 --timerange 20240101-20240301
freqtrade hyperopt -s NowoIchimoku5mV2 --hyperopt-loss SharpeHyperOptLoss
```
