...
ADX, ATR, BBANDS, CCI, DEMA, EMA, LINEARREG, MAX, MFI, MIN, MOM, ROC, ROCR, RSI, SMA, STOCHF, STOCHRSI, T3, TEMA, TRANGE, WMA, bollinger_bands, crossed_above, crossed_below, heikinashi, hull_moving_average, indicators, rolling_vwap, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s BBMod1`
