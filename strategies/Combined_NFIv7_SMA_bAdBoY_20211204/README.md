...
```bash
freqtrade backtesting -s Combined_NFIv7_SMA_bAdBoY_20211204 --timerange 20240101-20240301
freqtrade hyperopt -s Combined_NFIv7_SMA_bAdBoY_20211204 --hyperopt-loss SharpeHyperOptLoss
```
