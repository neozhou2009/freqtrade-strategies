# MarketChyperHyperStrategy 策略分析报告
...
- **策略名称**: MarketChyperHyperStrategy
- **时间框架**: 1h
- **止损设置**: -0.12447
- **最小ROI**: {'0': 0.23733, '238': 0.20624, '846': 0.08939, '1834': 0}
...
ADX, EMA, MACD, MINUS, PLUS, RSI, SMA, crossed_above, crossed_below, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s MarketChyperHyperStrategy`
