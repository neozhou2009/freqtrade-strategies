...
```bash
freqtrade backtesting -s MarketChyperHyperStrategy --timerange 20240101-20240301
freqtrade hyperopt -s MarketChyperHyperStrategy --hyperopt-loss SharpeHyperOptLoss
```
