...
class MarketChyperHyperStrategy(IStrategy):
    ...
    buy_uptrend_total_signal_needed = IntParameter(
        0, 100, default=65, space="buy", optimize=True, load=True
    )
    # wave trend
    buy_uptrend_wavetrend_weight = IntParameter(
        0, 100, default=0, space="buy", optimize=True, load=True
    )
    # rsi divs
    ...
    buy_uptrend_oslevel = IntParameter(
        -100, 0, default=0, space="buy", optimize=True, load=True
    )
    ...
    buy_sideways_oslevel = IntParameter(
        -100, 0, default=0, space="buy", optimize=True, load=True
    )
    ...
    sell_uptrend_total_signal_needed = IntParameter(
        0, 100, default=65, space="sell", optimize=True, load=True
    )
    # wave trend
    sell_uptrend_wavetrend_weight = IntParameter(
        0, 100, default=0, space="sell", optimize=True, load=True
    )
    # rsi divs
    ...
    sell_uptrend_oblevel = RealParameter(
        0, 100, default=0, space="sell", optimize=True, load=True
    )
    ...
    sell_sideways_oblevel = RealParameter(
        0, 100, default=0, space="sell", optimize=True, load=True
    )
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["macd"] = macd[
            "macd"
        ]  # MACD - Blue TradingView Line (Bullish if on top)
