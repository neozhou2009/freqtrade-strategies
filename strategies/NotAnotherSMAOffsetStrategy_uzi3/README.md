...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategy_uzi3 --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategy_uzi3 --hyperopt-loss SharpeHyperOptLoss
```
