# NotAnotherSMAOffsetStrategy_uzi3 策略分析报告
...
- **策略名称**: NotAnotherSMAOffsetStrategy_uzi3
- **时间框架**: 5m
- **止损设置**: -0.1
- **最小ROI**: {'0': 0.215, '40': 0.032, '87': 0.016}
...
EMA, RSI, SMA, bollinger_bands, hull_moving_average, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NotAnotherSMAOffsetStrategy_uzi3`
