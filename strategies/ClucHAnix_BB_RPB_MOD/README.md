...
本策略共检测到 11 个技术指标调用。基础配置看起来相对正常。
...
ADX, EMA, ROCR, RSI, SMA, STOCHF, bollinger_bands, crossed_above, heikinashi, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s ClucHAnix_BB_RPB_MOD`
