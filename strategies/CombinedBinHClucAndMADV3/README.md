...
```bash
freqtrade backtesting -s CombinedBinHClucAndMADV3 --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHClucAndMADV3 --hyperopt-loss SharpeHyperOptLoss
```
