...
| 周期 | 
    ...
    buy_fast_timeperiod = IntParameter(2, 50, default=9, space= |
| 指标 | 1个: SMA |
...
```bash
freqtrade backtesting -s Ichess --timerange 20240101-20240301
freqtrade hyperopt -s Ichess --hyperopt-loss SharpeHyperOptLoss
```
