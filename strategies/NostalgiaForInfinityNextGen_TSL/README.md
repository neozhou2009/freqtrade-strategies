...
```bash
freqtrade backtesting -s NostalgiaForInfinityNextGen_TSL --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityNextGen_TSL --hyperopt-loss SharpeHyperOptLoss
```
