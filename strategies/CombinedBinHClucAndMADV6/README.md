...
```bash
freqtrade backtesting -s CombinedBinHClucAndMADV6 --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHClucAndMADV6 --hyperopt-loss SharpeHyperOptLoss
```
