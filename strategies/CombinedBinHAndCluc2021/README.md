# CombinedBinHAndCluc2021 策略分析报告
...
- **策略名称**: CombinedBinHAndCluc2021
- **时间框架**: 5m
- **止损设置**: -0.09
- **最小ROI**: {'0': 0.0888, '21': 0.06115, '60': 0.02667, '80': 0.0}
...
2. 运行回测测试策略效果: `freqtrade backtesting -s CombinedBinHAndCluc2021`
