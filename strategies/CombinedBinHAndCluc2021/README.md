...
```bash
freqtrade backtesting -s CombinedBinHAndCluc2021 --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHAndCluc2021 --hyperopt-loss SharpeHyperOptLoss
```
