...
- **时间框架**: 5m
- **止损设置**: -0.03
- **最小ROI**: {'0': 0.15825, '28': 0.08491, '45': 0.04, '88': 0.0194, '120': 0}
...
MACD, SMA, crossed_above, crossed_below, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s MACD_TRIPLE_MA`
