...
```bash
freqtrade backtesting -s EMA_CROSSOVER_STRATEGY --timerange 20240101-20240301
freqtrade hyperopt -s EMA_CROSSOVER_STRATEGY --hyperopt-loss SharpeHyperOptLoss
```
