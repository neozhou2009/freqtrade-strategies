...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategyModHO --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategyModHO --hyperopt-loss SharpeHyperOptLoss
```
