...
本策略共检测到 17 个技术指标调用。基础配置看起来相对正常。
...
ADX, EMA, MACD, MAX, MFI, MIN, MINUS, PLUS, RSI, SAR, SMA, STOCHF, crossed_above, crossed_below, indicators, typical_price, weighted_bollinger_bands
