# CombinedBinHAndClucHyperV3 策略分析报告
...
- **策略名称**: CombinedBinHAndClucHyperV3
- **时间框架**: 1m
- **止损设置**: -0.06
- **最小ROI**: {'0': 3}
...
ATR, EMA, bollinger_bands, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s CombinedBinHAndClucHyperV3`
