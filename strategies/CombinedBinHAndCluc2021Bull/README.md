# CombinedBinHAndCluc2021Bull 策略分析报告
...
- **策略名称**: CombinedBinHAndCluc2021Bull
- **时间框架**: 5m
- **止损设置**: -0.09
- **最小ROI**: {'0': 0.01}
...
EMA, RSI, bollinger_bands, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s CombinedBinHAndCluc2021Bull`
