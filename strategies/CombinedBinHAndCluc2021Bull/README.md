...
| 周期 | 
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        # strategy BinHV45
        mid, lower = bollinger_bands(dataframe[ |
| 指标 | 3个: RSI,EMA,BB |
...
```bash
freqtrade backtesting -s CombinedBinHAndCluc2021Bull --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHAndCluc2021Bull --hyperopt-loss SharpeHyperOptLoss
```
