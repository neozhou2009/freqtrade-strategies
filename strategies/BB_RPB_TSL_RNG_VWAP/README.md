...
ADX, CCI, EMA, RSI, SMA, STOCHF, STOCHRSI, bollinger_bands, crossed_above, crossed_below, hull_moving_average, indicators, rolling_vwap, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s BB_RPB_TSL_RNG_VWAP`
