...
本策略是一个**EMA金叉/死叉、布林带突破、趋势判断**，旨在通过技术指标分析市场趋势，寻找买入和卖出机会。

### 核心逻辑

使用EMA快慢线交叉判断趋势转折点，金叉买入，死叉卖出；使用布林带判断价格是否突破支撑或阻力位；使用移动平均线判断市场整体趋势方向
...
- 最小ROI设置为 9999999900.0%，过于激进或不现实
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Babico_SMA5xBBmid`
