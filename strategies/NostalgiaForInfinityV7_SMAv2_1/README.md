...
```bash
freqtrade backtesting -s NostalgiaForInfinityV7_SMAv2_1 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV7_SMAv2_1 --hyperopt-loss SharpeHyperOptLoss
```
