# Strategy001_custom_sell 策略分析报告
...
- **策略名称**: Strategy001_custom_sell
- **时间框架**: 5m
- **止损设置**: -0.1
- **最小ROI**: {'60': 0.01, '30': 0.03, '20': 0.04, '0': 0.05}
...
EMA, RSI, crossed_above, heikinashi, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Strategy001_custom_sell`
