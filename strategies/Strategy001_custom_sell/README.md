...
```bash
freqtrade backtesting -s Strategy001_custom_sell --timerange 20240101-20240301
freqtrade hyperopt -s Strategy001_custom_sell --hyperopt-loss SharpeHyperOptLoss
```
