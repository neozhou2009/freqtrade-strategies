...
本策略共检测到 15 个技术指标调用。基础配置看起来相对正常。
...
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: {'0': 0.092, '29': 0.042, '85': 0.028, '128': 0.005}
...
ADX, CCI, EMA, MFI, ROCR, RSI, SMA, STOCHF, bollinger_bands, crossed_above, heikinashi, hull_moving_average, indicators, rolling_vwap, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s true_lambo`
