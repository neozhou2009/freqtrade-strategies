...
```bash
freqtrade backtesting -s ClucHAnix_BB_RPB_MOD_CTT --timerange 20240101-20240301
freqtrade hyperopt -s ClucHAnix_BB_RPB_MOD_CTT --hyperopt-loss SharpeHyperOptLoss
```
