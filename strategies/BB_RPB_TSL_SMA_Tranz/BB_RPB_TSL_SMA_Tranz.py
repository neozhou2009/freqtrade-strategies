...
class BB_RPB_TSL_SMA_Tranz(IStrategy):
    ...
    pump_protection_01_pct_change_timeframe = IntParameter(5, 10, default=8, space='entry', optimize=optimize_buy_pump_protection_01)
    pump_protection_01_pct_change_max = DecimalParameter(0.05, 0.35, default=0.15, space='entry', optimize=optimize_buy_pump_protection_01)
    pump_protection_01_pct_change_min = DecimalParameter(-0.35, -0.05, default=-0.15, space='entry', optimize=optimize_buy_pump_protection_01)

    pump_protection_01_pct_change_short_timeframe = IntParameter(5, 10, default=8, space='entry', optimize=optimize_buy_pump_protection_01)
    pump_protection_01_pct_change_short_max = DecimalParameter(0.05, 0.35, default=0.08, space='entry', optimize=optimize_buy_pump_protection_01)
    pump_protection_01_pct_change_short_min = DecimalParameter(-0.35, -0.05, default=-0.08, space='entry', optimize=optimize_buy_pump_protection_01)

    pump_protection_01_ispumping = DecimalParameter(0.05, 0.35, default=0.2, space='entry', optimize=optimize_buy_pump_protection_01)
    pump_protection_01_islongpumping = DecimalParameter(0.05, 0.35, default=0.24, space='entry', optimize=optimize_buy_pump_protection_01)
    pump_protection_01_isshortpumping = DecimalParameter(0.05, 0.35, default=0.12, space='entry', optimize=optimize_buy_pump_protection_01)
