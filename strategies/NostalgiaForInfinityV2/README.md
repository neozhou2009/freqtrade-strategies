...
```bash
freqtrade backtesting -s NostalgiaForInfinityV2 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV2 --hyperopt-loss SharpeHyperOptLoss
```
