...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategyHO --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategyHO --hyperopt-loss SharpeHyperOptLoss
```
