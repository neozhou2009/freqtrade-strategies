# NotAnotherSMAOffsetStrategyHO 策略分析报告
...
- **策略名称**: NotAnotherSMAOffsetStrategyHO
- **时间框架**: 5m
- **止损设置**: -0.35
- **最小ROI**: {'0': 0.289, '25': 0.105, '80': 0.038, '140': 0}
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NotAnotherSMAOffsetStrategyHO`
