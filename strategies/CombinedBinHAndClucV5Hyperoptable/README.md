...
| 周期 | 
    ...
    sell_profit_offset = 0.001 # it doesn |
| 指标 | 2个: EMA,BB |
...
```bash
freqtrade backtesting -s CombinedBinHAndClucV5Hyperoptable --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHAndClucV5Hyperoptable --hyperopt-loss SharpeHyperOptLoss
```
