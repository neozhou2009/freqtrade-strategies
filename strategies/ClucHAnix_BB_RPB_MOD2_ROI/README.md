...
```bash
freqtrade backtesting -s ClucHAnix_BB_RPB_MOD2_ROI --timerange 20240101-20240301
freqtrade hyperopt -s ClucHAnix_BB_RPB_MOD2_ROI --hyperopt-loss SharpeHyperOptLoss
```
