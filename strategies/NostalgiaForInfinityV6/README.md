...
```bash
freqtrade backtesting -s NostalgiaForInfinityV6 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV6 --hyperopt-loss SharpeHyperOptLoss
```
