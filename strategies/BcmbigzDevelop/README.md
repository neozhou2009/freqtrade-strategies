...
```bash
freqtrade backtesting -s BcmbigzDevelop --timerange 20240101-20240301
freqtrade hyperopt -s BcmbigzDevelop --hyperopt-loss SharpeHyperOptLoss
```
