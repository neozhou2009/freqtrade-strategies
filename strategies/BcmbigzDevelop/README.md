...
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: "0": 0.038, "20": 0.028, "40": 0.02, "60": 0.015, "180": 0.018,
...
EMA (指数移动平均)、SMA (简单移动平均)、RSI (相对强弱指标)、MACD (移动平均收敛散度)、ATR (平均真实波幅)、MFI (资金流量指标)
...
2. 运行回测测试策略效果: `freqtrade backtesting -s BcmbigzDevelop`
