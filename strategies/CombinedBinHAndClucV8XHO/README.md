...
```bash
freqtrade backtesting -s CombinedBinHAndClucV8XHO --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHAndClucV8XHO --hyperopt-loss SharpeHyperOptLoss
```
