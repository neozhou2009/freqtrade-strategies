...
```bash
freqtrade backtesting -s ElliotV8_original_ichiv3 --timerange 20240101-20240301
freqtrade hyperopt -s ElliotV8_original_ichiv3 --hyperopt-loss SharpeHyperOptLoss
```
