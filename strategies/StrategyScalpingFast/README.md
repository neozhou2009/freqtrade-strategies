...
```bash
freqtrade backtesting -s StrategyScalpingFast --timerange 20240101-20240301
freqtrade hyperopt -s StrategyScalpingFast --hyperopt-loss SharpeHyperOptLoss
```
