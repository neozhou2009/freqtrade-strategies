...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategy --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategy --hyperopt-loss SharpeHyperOptLoss
```
