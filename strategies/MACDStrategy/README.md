...
| 周期 | 
    ...
    buy_cci = IntParameter(low=-700, high=0, default=-50, space= |
| 指标 | 2个: RSI,MACD |
...
```bash
freqtrade backtesting -s MACDStrategy --timerange 20240101-20240301
freqtrade hyperopt -s MACDStrategy --hyperopt-loss SharpeHyperOptLoss
```
