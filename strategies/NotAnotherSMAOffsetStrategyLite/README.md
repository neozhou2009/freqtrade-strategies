...
```bash
freqtrade backtesting -s NotAnotherSMAOffsetStrategyLite --timerange 20240101-20240301
freqtrade hyperopt -s NotAnotherSMAOffsetStrategyLite --hyperopt-loss SharpeHyperOptLoss
```
