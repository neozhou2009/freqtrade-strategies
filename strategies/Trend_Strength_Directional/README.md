...
- **策略名称**: Trend_Strength_Directional
- **时间框架**: 15m
- **止损设置**: -0.314
- **最小ROI**: {'0': 0.383, '120': 0.082, '283': 0.045, '495': 0}
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Trend_Strength_Directional`
