...
```bash
freqtrade backtesting -s Trend_Strength_Directional --timerange 20240101-20240301
freqtrade hyperopt -s Trend_Strength_Directional --hyperopt-loss SharpeHyperOptLoss
```
