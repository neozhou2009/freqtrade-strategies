...
- **策略名称**: FrostAuraM21hStrategy
- **时间框架**: 15m
- **止损设置**: -0.44897
- **最小ROI**: {'0': 0.32365, '359': 0.12673, '934': 0.08834, '2090': 0}
...
2. 运行回测测试策略效果: `freqtrade backtesting -s FrostAuraM21hStrategy`
