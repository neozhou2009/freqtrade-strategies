...
本策略共检测到 18 个技术指标调用。基础配置看起来相对正常。
...
- **时间框架**: 5m
- **止损设置**: -0.085
- **最小ROI**: {'0': 0.213, '39': 0.103, '96': 0.037, '166': 0}
...
ADX, ATR, DMI, EMA, MFI, ROC, RSI, SAR, SMA, SQZMI, STOCHF, VFI, bollinger_bands, chopiness, crossed_above, crossed_below, indicators, typical_price
