...
class GodStraNew40(IStrategy):
    ...
    buy_crossed_indicator0 = CategoricalParameter(
        ...
        default=buy_params["buy_crossed_indicator0"],
        space="buy",
    )
    buy_crossed_indicator1 = CategoricalParameter(
        god_genes_with_timeperiod,
        default=buy_params["buy_crossed_indicator1"],
        space="buy",
    )
    buy_crossed_indicator2 = CategoricalParameter(
        god_genes_with_timeperiod,
        default=buy_params["buy_crossed_indicator2"],
        space="buy",
    )
    ...
    sell_crossed_indicator0 = CategoricalParameter(
        god_genes_with_timeperiod,
        default=sell_params["sell_crossed_indicator0"],
        space="sell",
    )
    sell_crossed_indicator1 = CategoricalParameter(
        god_genes_with_timeperiod,
        default=sell_params["sell_crossed_indicator1"],
        space="sell",
    )
    sell_crossed_indicator2 = CategoricalParameter(
        god_genes_with_timeperiod,
        default=sell_params["sell_crossed_indicator2"],
        space="sell",
    )
