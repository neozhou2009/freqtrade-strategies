...
```bash
freqtrade backtesting -s NostalgiaForInfinityV7_SMA --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV7_SMA --hyperopt-loss SharpeHyperOptLoss
```
