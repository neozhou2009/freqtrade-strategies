...
```bash
freqtrade backtesting -s NostalgiaForInfinityV4HO --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV4HO --hyperopt-loss SharpeHyperOptLoss
```
