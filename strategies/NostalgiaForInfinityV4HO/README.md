# NostalgiaForInfinityV4HO 策略分析报告
...
本策略共检测到 8 个技术指标调用。存在高风险配置项，请务必注意。
...
EMA, MFI, RSI, SMA, bollinger_bands, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NostalgiaForInfinityV4HO`
