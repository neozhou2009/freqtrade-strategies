...
```bash
freqtrade backtesting -s FrostAuraM315mStrategy --timerange 20240101-20240301
freqtrade hyperopt -s FrostAuraM315mStrategy --hyperopt-loss SharpeHyperOptLoss
```
