...
```bash
freqtrade backtesting -s NASOSRv6_private_Reinuvader_20211121 --timerange 20240101-20240301
freqtrade hyperopt -s NASOSRv6_private_Reinuvader_20211121 --hyperopt-loss SharpeHyperOptLoss
```
