...
RSI, bollinger_bands, crossed_above, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s STRATEGY_RSI_BB_CROSS`
