...
- **时间框架**: 5m
- **止损设置**: -0.10145
- **最小ROI**: {'0': 0.20934, '238': 0.06449, '1931': 0.01703, '3474': 0}
...
BBANDS, CMO, TEMA, bollinger_bands, crossed_above, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s TemaPureNeat`
