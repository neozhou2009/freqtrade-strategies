...
```bash
freqtrade backtesting -s CombinedBinHClucAndMADV5 --timerange 20240101-20240301
freqtrade hyperopt -s CombinedBinHClucAndMADV5 --hyperopt-loss SharpeHyperOptLoss
```
