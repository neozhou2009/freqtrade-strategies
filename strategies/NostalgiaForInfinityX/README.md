...
ADX, ATR, BBANDS, CCI, DEMA, EMA, MFI, MOM, ROC, RSI, SMA, STOCHF, STOCHRSI, T3, TEMA, WMA, bollinger_bands, crossed_above, crossed_below, heikinashi, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NostalgiaForInfinityX`
