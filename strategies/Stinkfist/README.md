...
- **时间框架**: 5m
- **止损设置**: -0.4
- **最小ROI**: {'0': 0.05, '10': 0.025, '20': 0.015, '30': 0.01, '720': 0.005, '1440': 0}
...
EMA, ROC, RSI, crossed_above, crossed_below, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s Stinkfist`
