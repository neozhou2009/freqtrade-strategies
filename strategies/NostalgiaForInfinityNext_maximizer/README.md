...
```bash
freqtrade backtesting -s NostalgiaForInfinityNext_maximizer --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityNext_maximizer --hyperopt-loss SharpeHyperOptLoss
```
