...
class SMAOPv1_TTF(IStrategy):
    ...
    # TTF
    ttf_length = IntParameter(1, 50, default=15, space="buy")
    ttf_upperTrigger = IntParameter(1, 400, default=100, space="buy")
    ttf_lowerTrigger = IntParameter(1, -400, default=-100, space="buy")
