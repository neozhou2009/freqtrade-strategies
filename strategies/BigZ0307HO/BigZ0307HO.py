...
class BigZ0307HO(IStrategy):
    ...
    buy_bb20_close_bblowerband_safe_1 = DecimalParameter(
        0.7, 1.1, default=0.989, space="buy", optimize=buy_bb20_optimize, load=True
    )
    buy_bb20_close_bblowerband_safe_2 = DecimalParameter(
        0.7, 1.1, default=0.982, space="buy", optimize=buy_bb20_optimize, load=True
    )
    ...
    buy_condition_1_rsi_1h = DecimalParameter(
        63, 75, default=69, space="buy", decimals=1, optimize=False, load=True
    )
    ...
    custom_stoploss_minutes = IntParameter(
        ...
        default=50,
        space="sell",
        optimize=custom_stoploss_optimize_2,
        load=True,
    )
    ...
    sell_custom_stoploss_long_recover_2 = DecimalParameter(
        ...
        default=0.06,
        space="sell",
        optimize=sell_custom_stoploss_2_optimize,
        load=True,
    )
        ...
        if current_profit > 0:
            ...
            if trade_time_50 > trade.open_date_utc:
                try:
                    ...
                    if (
                        current_rate * self.custom_stoploss_current_rates_2.value
                        < candle["open"]
                    ):
                        return 0.015
