...
```bash
freqtrade backtesting -s NostalgiaForInfinityNext_ChangeToTower_V5_2 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityNext_ChangeToTower_V5_2 --hyperopt-loss SharpeHyperOptLoss
```
