# NostalgiaForInfinityNext_ChangeToTower_V5_2 策略分析报告
...
本策略共检测到 19 个技术指标调用。基础配置看起来相对正常。
...
- **策略名称**: NostalgiaForInfinityNext_ChangeToTower_V5_2
- **时间框架**: 5m
- **止损设置**: -0.99
- **最小ROI**: {'0': 10}
...
ATR, CCI, DEMA, EMA, MFI, RSI, SMA, STOCHRSI, T3, TEMA, TRANGE, WMA, bollinger_bands, chopiness, crossed_above, crossed_below, heikinashi, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NostalgiaForInfinityNext_ChangeToTower_V5_2`
