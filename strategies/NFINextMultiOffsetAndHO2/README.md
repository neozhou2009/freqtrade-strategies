...
```bash
freqtrade backtesting -s NFINextMultiOffsetAndHO2 --timerange 20240101-20240301
freqtrade hyperopt -s NFINextMultiOffsetAndHO2 --hyperopt-loss SharpeHyperOptLoss
```
