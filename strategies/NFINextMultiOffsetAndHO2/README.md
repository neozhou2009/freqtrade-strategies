# NFINextMultiOffsetAndHO2 策略分析报告
...
EMA, KAMA, MFI, RSI, SMA, STOCHRSI, T3, TRIMA, WMA, bollinger_bands, chopiness, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NFINextMultiOffsetAndHO2`
