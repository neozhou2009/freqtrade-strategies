# NostalgiaForInfinityNextGen 策略分析报告
...
- **策略名称**: NostalgiaForInfinityNextGen
- **时间框架**: 15m
- **止损设置**: -0.5
- **最小ROI**: {'0': 100.0}
...
BBANDS, CCI, EMA, MFI, MOM, ROC, RSI, SMA, bollinger_bands, crossed_above, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s NostalgiaForInfinityNextGen`
