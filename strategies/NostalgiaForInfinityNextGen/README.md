...
```bash
freqtrade backtesting -s NostalgiaForInfinityNextGen --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityNextGen --hyperopt-loss SharpeHyperOptLoss
```
