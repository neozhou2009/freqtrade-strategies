...
```bash
freqtrade backtesting -s Ichimoku_SenkouSpanCross --timerange 20240101-20240301
freqtrade hyperopt -s Ichimoku_SenkouSpanCross --hyperopt-loss SharpeHyperOptLoss
```
