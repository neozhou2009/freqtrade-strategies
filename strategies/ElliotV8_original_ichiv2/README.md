...
```bash
freqtrade backtesting -s ElliotV8_original_ichiv2 --timerange 20240101-20240301
freqtrade hyperopt -s ElliotV8_original_ichiv2 --hyperopt-loss SharpeHyperOptLoss
```
