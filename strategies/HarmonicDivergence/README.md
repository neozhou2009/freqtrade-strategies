...
ADX, CCI, EMA, MACD, MFI, OBV, ROC, RSI, STOCH, ULTOSC, atr, awesome_oscillator, bollinger_bands, crossed_below, indicators, keltner_channel, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s PlotConfig`
