...
```bash
freqtrade backtesting -s HarmonicDivergence --timerange 20240101-20240301
freqtrade hyperopt -s HarmonicDivergence --hyperopt-loss SharpeHyperOptLoss
```
