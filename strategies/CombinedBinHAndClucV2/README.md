...
- **策略名称**: CombinedBinHAndClucV2
- **时间框架**: 5m
- **止损设置**: -0.05
- **最小ROI**: {'120': 0.01, '60': 0.02, '30': 0.05, '0': 0.1}
...
ATR, EMA, MFI, RSI, STOCHRSI, bollinger_bands, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s CombinedBinHAndClucV2`
