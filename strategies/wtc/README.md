...
| 周期 | 
    ...
    buy_max = DecimalParameter(-1, 1, decimals=4, default=0.4393, space= |
| 指标 | 3个: RSI,EMA,SMA |
...
```bash
freqtrade backtesting -s wtc --timerange 20240101-20240301
freqtrade hyperopt -s wtc --hyperopt-loss SharpeHyperOptLoss
```
