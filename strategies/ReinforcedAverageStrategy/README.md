...
```bash
freqtrade backtesting -s ReinforcedAverageStrategy --timerange 20240101-20240301
freqtrade hyperopt -s ReinforcedAverageStrategy --hyperopt-loss SharpeHyperOptLoss
```
