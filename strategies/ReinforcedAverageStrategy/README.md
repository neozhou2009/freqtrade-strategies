# ReinforcedAverageStrategy 策略分析报告
...
- **策略名称**: ReinforcedAverageStrategy
- **时间框架**: 4h
- **止损设置**: -0.2
- **最小ROI**: {'0': 0.5}
...
EMA, SMA, bollinger_bands, crossed_above, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s ReinforcedAverageStrategy`
