...
| 周期 | 
    ...
    # buy params
    buy_mojo_ma_timeframe = IntParameter(2, 100, default=7, space= |
| 指标 | 1个: SMA |
...
```bash
freqtrade backtesting -s mabStra --timerange 20240101-20240301
freqtrade hyperopt -s mabStra --hyperopt-loss SharpeHyperOptLoss
```
