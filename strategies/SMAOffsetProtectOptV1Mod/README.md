...
```bash
freqtrade backtesting -s SMAOffsetProtectOptV1Mod --timerange 20240101-20240301
freqtrade hyperopt -s SMAOffsetProtectOptV1Mod --hyperopt-loss SharpeHyperOptLoss
```
