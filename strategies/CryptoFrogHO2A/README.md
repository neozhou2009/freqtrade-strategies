...
本策略共检测到 16 个技术指标调用。基础配置看起来相对正常。
...
- **时间框架**: 5m
- **止损设置**: -0.13
- **最小ROI**: {'0': 0.09, '39': 0.028, '49': 0.011, '105': 0}
...
ADX, ATR, DMI, EMA, MFI, ROC, RSI, SAR, SMA, SQZMI, STOCHF, VFI, bollinger_bands, crossed_above, indicators, typical_price
