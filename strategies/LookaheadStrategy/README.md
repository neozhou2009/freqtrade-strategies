...
- **策略名称**: LookaheadStrategy
- **时间框架**: 5m
- **止损设置**: -0.194
- **最小ROI**: {'0': 0.166, '44': 0.012, '59': 0}
...
EMA, SMA, crossed_above, crossed_below, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s LookaheadStrategy`
