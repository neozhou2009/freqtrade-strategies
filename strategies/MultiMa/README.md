...
| 周期 | 
    ...
    buy_ma_count = IntParameter(1, count_max, default=7, space= |
| 指标 | 1个: EMA |
...
```bash
freqtrade backtesting -s MultiMa --timerange 20240101-20240301
freqtrade hyperopt -s MultiMa --hyperopt-loss SharpeHyperOptLoss
```
