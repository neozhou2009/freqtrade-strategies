...
```bash
freqtrade backtesting -s NostalgiaForInfinityV7_SMAv2 --timerange 20240101-20240301
freqtrade hyperopt -s NostalgiaForInfinityV7_SMAv2 --hyperopt-loss SharpeHyperOptLoss
```
