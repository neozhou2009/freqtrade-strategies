...
- **时间框架**: 5m
- **止损设置**: -0.11
- **最小ROI**: {'0': 0.12607, '331': 0.12606, '865': 0.12605, '1945': 0.01}
...
BBANDS, CMO, TEMA, crossed_above, crossed_below, indicators
...
2. 运行回测测试策略效果: `freqtrade backtesting -s TemaPureTwo`
