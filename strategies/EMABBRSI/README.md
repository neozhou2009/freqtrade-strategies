...
- **时间框架**: 5m
- **止损设置**: -0.2
- **最小ROI**: {'0': 0.14142349227153977, '25': 0.04585271106137356, '41': 0.020732379189664467, '67': 0}
...
EMA, RSI, bollinger_bands, crossed_above, crossed_below, indicators, typical_price
...
2. 运行回测测试策略效果: `freqtrade backtesting -s EMABBRSI`
