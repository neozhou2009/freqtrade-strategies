...
```bash
freqtrade backtesting -s Obelisk_Ichimoku_Slow_v1_3 --timerange 20240101-20240301
freqtrade hyperopt -s Obelisk_Ichimoku_Slow_v1_3 --hyperopt-loss SharpeHyperOptLoss
```
